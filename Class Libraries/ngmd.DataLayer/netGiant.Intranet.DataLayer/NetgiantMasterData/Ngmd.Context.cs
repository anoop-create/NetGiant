...
namespace DataAccess.EntityFramework
{
    ...
    public partial class Ngmd : DbContext
    {
        ...
        public virtual DbSet<FraudCriteria> FraudCriterias { get; set; }
        public virtual DbSet<McOrderData> McOrderDatas { get; set; }
        public virtual DbSet<McCartData> McCartDatas { get; set; }
        public virtual DbSet<VoucherPromo> VoucherPromoes { get; set; }
        public virtual DbSet<LookupNgmd> LookupNgmds { get; set; }
        public virtual DbSet<LookupTypeNgmd> LookupTypeNgmds { get; set; }
        ...
        public virtual DbSet<deliverySupplierCode> deliverySupplierCode { get; set; }
        ...
        public virtual IQueryable<fnSplit_Result> fnSplit(string sInputList, string sDelimiter)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<fnSplit_Result>("[Ngmd].[fnSplit](@sInputList, @sDelimiter)", sInputListParameter, sDelimiterParameter);
        }
        ...
        public virtual int GetCMSEntry(string siteCode, Nullable<int> seriesId, Nullable<int> entryId, string entryType)
        {
            var siteCodeParameter = siteCode != null ?
                new ObjectParameter("SiteCode", siteCode) :
                new ObjectParameter("SiteCode", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("GetCMSEntry", siteCodeParameter, seriesIdParameter, entryIdParameter, entryTypeParameter);
        }
        ...
        [DbFunction("Ngmd", "GetProductPrices")]
        public virtual IQueryable<GetProductPrices_Result> GetProductPrices(string altRef)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<GetProductPrices_Result>("[Ngmd].[GetProductPrices](@altRef)", altRefParameter);
        }
        ...
        [DbFunction("Ngmd", "GetProductSuppliers")]
        public virtual IQueryable<GetProductSuppliers_Result> GetProductSuppliers(string altRef, Nullable<int> manufacturerFK)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<GetProductSuppliers_Result>("[Ngmd].[GetProductSuppliers](@altRef, @manufacturerFK)", altRefParameter, manufacturerFKParameter);
        }
        ...
        public virtual IQueryable<StringSplit_Result> StringSplit(string sString, string cDelimiter)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<StringSplit_Result>("[Ngmd].[StringSplit](@sString, @cDelimiter)", sStringParameter, cDelimiterParameter);
        }
