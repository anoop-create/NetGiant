...
namespace SharedUI.Controllers
{
    ...
    public class EquipmentController : WizardController
    {
        ...
        public ActionResult PrinterWizard(string typename = null, string manuname = null, string familyname = null)
        {
            ...
            // Temporary code to test family equipment links
            ViewBag.ShowLinks = false;
            List<int> showManu = Utilities.GetItemFromDict(model.EquipmentData, "ShowFamilyEquipmentLinks").Split(',').Select(Int32.Parse).ToList();
