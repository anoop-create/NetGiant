...
namespace SharedUI.Controllers
{
    ...
    public class ProductController : ApplicationController
    {
        ...
        public ActionResult Index(string productname, string id)
        {
            ...
            {
                model.BreadcrumbTrail.Add(model.Product.Type + " Cartridges", "https://" + model.CommonData["DomainName"] + (model.Product.Type + " Cartridges").ToLower().Replace(' ', '-') + "/");
                if (ViewBag.Brand != "")
                {
                    model.BreadcrumbTrail.Add(ViewBag.Brand, "https://" + model.CommonData["DomainName"] + (model.Product.Type + " Cartridges").ToLower().Replace(' ', '-') + "/" + ViewBag.Brand.Replace(' ', '-') + "/");
                }
            }
            else
            {
                model.BreadcrumbTrail.Add(model.Product.CategoryCodeName, "https://" + model.CommonData["DomainName"] + "/products/" + Utilities.CleanUrl(model.Product.CategoryCodeName).ToLower() + "-" + model.Product.AxisGroupNo + "/");
            }
        ...
        public ActionResult ProductList(string equipname, string filter = "")
        {
            ...
            model.BreadcrumbTrail.Add(model.EquipmentDetail.Rows[0]["CartridgeTypeName"].ToString(), "https://" + model.CommonData["DomainName"] + "/" + model.EquipmentDetail.Rows[0]["CartridgeTypeName"].ToString().ToLower().Replace(' ', '-')  + "/");
            model.BreadcrumbTrail.Add(model.EquipmentDetail.Rows[0]["Brand"].ToString(), "https://" + model.CommonData["DomainName"] + "/" + model.EquipmentDetail.Rows[0]["CartridgeTypeName"].ToString().ToLower().Replace(' ', '-') + "/" + model.EquipmentDetail.Rows[0]["Brand"].ToString().Replace(' ', '-') + "/");
