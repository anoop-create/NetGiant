    ...
    public class EquipmentViewModel : WizardViewModel
    {
        ...
        public void SetupWizard(string typename = null, string manuname = null, string familyname = null)
        {
            ...
            if (typename != null)
            {
                ...
                GetCartridgeTypes();
                CartridgeType = CartridgeTypes.Find(x => x.eqCartridgeTypeName.ToLower() == typename);
                if (CartridgeType != null)
                {
                    typeId = CartridgeType.eqCartridgeTypeID;
                    CartridgeTypeName = CartridgeType.eqCartridgeTypeName;
                }
            }
            if (manuname != null)
            {
        ...
        //public string ManuNotes { get; set; }
        public manufacturer Manufacturer = null;
        public eqFamily Family = null;
        public eqCartridgeType CartridgeType = null;
        ...
        public void GetMeta(eqCartridgeType type, manufacturer manu, eqFamily family)
        {
            ...
            if (manu != null)
            {
                var manuNote = manu.manufacturerNotes.FirstOrDefault(x => x.eqCartridgeTypeFK == type.eqCartridgeTypeID && x.websiteFK == w);
                if (manuNote != null)
            ...
            {
                manufacturerNote note = EntityAccess.ReadManufacturerNotes(x => x.eqCartridgeTypeFK == type.eqCartridgeTypeID && x.manufacturerFK == null).FirstOrDefault();
