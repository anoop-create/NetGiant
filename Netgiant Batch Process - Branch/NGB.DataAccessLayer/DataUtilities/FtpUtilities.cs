...
namespace NGBP.DataAccessLayer.DataUtilities
{
    public class FtpUtilities
    {
        ...
        {
            //Create the ftp web request
            FtpWebRequest requestDirectory = (FtpWebRequest)WebRequest.Create($"{host}/{file}");
            ...
            var returnValue = responseFile.LastModified;
        ...
        public static void UploadFTPFile(string filePath, string ftpAddress, string ftpUN, string ftpPW, bool ftpSsl = false)
        {
            FtpWebRequest request = (FtpWebRequest)WebRequest.Create(ftpAddress);
            request.Method = WebRequestMethods.Ftp.UploadFile;
            request.Credentials = new NetworkCredential(ftpUN, ftpPW);
            request.EnableSsl = ftpSsl;
