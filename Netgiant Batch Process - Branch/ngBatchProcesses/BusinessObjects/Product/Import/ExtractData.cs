...
namespace ngBatchProcesses.BusinessObjects.Product.Import
{
    public class ExtractData
    {
        ...
        {
            string suppressCnetImg = DataTableColExists(row, "Suppress cnet image") == true ? row["Suppress cnet image"].ToString().ToLower() : null;
            string suppressCnetDesc = DataTableColExists(row, "Suppress cnet description") == true ? row["Suppress cnet description"].ToString().ToLower() : null;
            ...
            fields.supressCnetImage = SetBoolean(suppressCnetImg);
            fields.supressCnetDesc = SetBoolean(suppressCnetDesc);
        ...
        private manufacturer GetManufacturerFK(AxisValueLookup avl)
        {
            ...
            using (ngmdEntities db = new ngmdEntities())
            {
                if (avl.attrValueDesc.ToLower() == "hewlett packard")
                {
                    avl.attrValueDesc = "HP";
                }
