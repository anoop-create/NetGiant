...
namespace ngBatchProcesses.BusinessObjects.EcommerceWebsite
{
    public class StaticFiles
    {
        ...
        private static void CreateMastheadMenu(Dictionary<string, string> parms)
        {
            // ------------------------------------------------------------------------------------------- //
            // Key                                                                                         //
            ...
            StandardFunctions.SetSiteConfigSettings(websiteId);

            //string addressPrefix = "";
            //if (StandardFunctions.WebsiteConfigSettings.Where(x => x.settingName == "UseHTTPS").FirstOrDefault().settingValue == "True")
            //{
            //    addressPrefix = "https://";
            //}
            //else
            ...
            try
            {
                ...
                {
                    string siteRoot = StandardFunctions.WebsiteConfigSettings.Where(x => x.settingName == "siteRoot")
                        .FirstOrDefault().settingValue;
                    string version = StandardFunctions.WebsiteConfigSettings
                        .Where(x => x.settingName == "VersionNumber").FirstOrDefault().settingValue;
                    string cdn = StandardFunctions.WebsiteConfigSettings.Where(x => x.settingName == "CDN")
                        .FirstOrDefault().settingValue;
                    cdn = cdn.Replace("[version]", version);

                    //Get the Menu Control Settings for this website
                    List<configurationSetting> menus;
                    menus = StandardFunctions.WebsiteConfigSettings.Where(x => x.settingName.StartsWith("menu"))
                        .OrderBy(y => y.settingName).ToList();
                    string siteCode = StandardFunctions.WebsiteConfigSettings.Where(x => x.settingName == "site")
                        .FirstOrDefault().settingValue;
                            ...
                            case "2":
                                {
                                    ...
                                    if (menuSetting.Count() > 5)
                                    {
                                        ...
                                        {
                                            where = (x => x.eqCartridgeTypeFK != typeId && x.eqCartridgeTypeFK != 8 &&
                                                          x.statusFK == 1); // 8 = HP Range
                                        }
                                    }
                                    ...
                                    html.AppendLine("<div class=\"g-va-t text-left col-lg-3 visible-lg g-p-l-0\">" +
                                                    StandardFunctions.GetNgmdCMSEntry(websiteId, "MenuData",
                                    ...
                                    var manulist = (db.eqEquipment
                                            .Include(y => y.manufacturer)
                                            .Include(y => y.eqCartridgeType)
                                            .Where(where)
                                            .Select(x => new
                                            {
                                                Item1 = x.manufacturer.manufacturerName,
                                                Item2 = x.eqCartridgeType.eqCartridgeTypeName,
                                    ...
                                    for (i = 0; i <= manulist.Count - 1; i++)
                                    {
                                        ...
                                        if (i == manulist.Count - 1 || manulist[i + 1].Item1 != manu.Item1)
                                        {
                                            ...
                                            html.AppendLine("<img src=\"/Content/Images/1pxTrans.png\" class=\"pbs_" +
                                                            ...
                                                            " " + menuSetting[2] + "\">");
                                            //html.AppendLine("<span class=\"visible-xs\">" + manu.Item1 + " " + menuSetting[2] + "</span>");
                                            html.AppendLine("</a>");
                                            html.AppendLine("</li>");
                                        }
                                        else
                            ...
                            case "3":
                                {
                                    ...
                                    parentGroup = db.categoryCode
                                        //.Include(x => x.categoryCode)
                                        .Where(x => x.AXISGroupNo.Trim() == menuGroupNo1)
                                        .FirstOrDefault();

                                    if (parentGroup != null)
                                    {
                                        categoryCodes = db.categoryCode
                                            .Where(x => x.parentCategoryCodeID == parentGroup.categoryCodeID)
                                        ...
                                        url = "/catalogue/" +
                                              ...
                                              menuSetting[4] + "/";
                                        html.AppendLine("<li>");
                                        html.AppendLine("<a href=\"" + url + "\" class=\"topLevelLink\">" + menuSetting[2] +
                                                        newSash +
                                                        "<i class=\"fa fa-chevron-down pull-right hidden-xs hidden-sm g-p-r-10\" aria-hidden=\"true\"></i></a>");
                                        html.AppendLine("<div class=\"g-d-n\">");
                                        html.AppendLine("<div class=\"g-va-t text-left col-lg-3 visible-lg g-p-l-0\">" +
                                            ...
                                            if (cnt1 > 0 || cnt2 > 0)
                                            {
                                                ...
                                                html.AppendLine("<div class=\"hidden-xs\"><img src=\"/Content/Images/1pxTrans.png\"  data-original=\"" + cdn +
                                                                ...
                                                                cc.categoryCodeName.Replace("& ", "").Replace(" ", "-")
                                                                    .ToLower() +
                                                                ".jpg\" class=\"deferImage g-b-1-p g-h-100 g-hoverbox\" alt=\"" +
                            ...
                            case "4":
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        parentCC = db.categoryCode
                                            .Where(x => (x.AXISGroupNo ?? "0").Trim() == menuGroupNo2)
                                            .FirstOrDefault();
                                        ...
                                        if (parentCC != null)
                                        {
                                            ...
                                            topCC = db.categoryCode
                                                //.Include("categoryCode.websiteInventory.product")
                                                .Where(x => x.parentCategoryCodeID == parentCC.categoryCodeID)
                                                .OrderBy(x => x.categoryCodeName)
                                                .ToList();
                                            ...
                                            foreach (categoryCode tc in topCC)
                                            {
                                                if (CategoryHasProducts(tc))
                                                {
                                                    ...
                                                    List<categoryCode> subCC = db.categoryCode
                                                        .Where(x => x.parentCategoryCodeID == tc.categoryCodeID)
                                                        .OrderBy(x => x.categoryCodeName)
                                                        .ToList();
                            ...
                            case "5":
                                {
                                    ...
                                    if (menuSetting[5] == "1")
                                    {
                                        ...
                                        html.AppendLine(StandardFunctions.GetCMSEntry(3, 45, 2, "T"));
                                    }
                                    else
                                    {
                                        //Get a list of all the Top Groups associated with the parent group
                                    ...
                                    html.AppendLine("</ul>" + Environment.NewLine + "</li>");
                                    break;
                                }
                    ...
                    // Mobile Links
                    html.Append(StandardFunctions.GetNgmdCMSEntry(websiteId, "MenuData", "MobileAddOn"));
                }
            }
            catch (Exception ex)
            {
            ...
            if (errorHasOccurred == false)
            {
                try
                {
                    writeHTMLFile(html.ToString(), parms["output"]);

                    DataCache cache = new DataCache(websiteId);
                    cache.ClearCache("Menu");
                }
                catch (Exception ex)
                {
                    errorHasOccurred = true;
            ...
            if (errorHasOccurred)
            {
                stnFunc.AddToActivityLog("Error Occurred: " + errorMessage + " Process Finished");
            }
        ...
        private static bool HasTGPrice(int productID)
        {
            ...
            using (ngmdEntities db = new ngmdEntities())
            {
                websiteInventory wiTG = db.product.Find(productID).websiteInventory.Where(x => x.websiteFK == 1)
                    .FirstOrDefault();
        ...
        public static bool CategoryHasProducts(categoryCode cc)
        {
            ...
            using (ngmdEntities db = new ngmdEntities())
            {
                List<categoryCode> ccBottom = db.categoryCode.Where(x => x.parentCategoryCodeID == cc.categoryCodeID)
                    .ToList();
        ...
        private static void CreateFooterStd(Dictionary<string, string> parms)
        {
            ...
            if (StandardFunctions.WebsiteConfigSettings.Where(x => x.settingName == "UseHTTPS").FirstOrDefault()
                    .settingValue == "True")
            {
                addressPrefix = "https://";
            }
            ...
            try
            {
                using (ngmdEntities db = new ngmdEntities())
                {
                    siteRoot = addressPrefix + StandardFunctions.WebsiteConfigSettings
                                   .Where(x => x.settingName == "siteRoot").FirstOrDefault().settingValue;
                    siteName = StandardFunctions.WebsiteConfigSettings.Where(x => x.settingName == "siteName")
                        .FirstOrDefault().settingValue;
                    ...
                    string siteCode = StandardFunctions.WebsiteConfigSettings.Where(x => x.settingName == "site")
                        .FirstOrDefault().settingValue;
                    string supportEmailAddress = StandardFunctions.WebsiteConfigSettings
                    ...
                    html += StandardFunctions.GetCMSEntry(websiteId, 41, 12, "T") + Environment.NewLine;
                    html += "</div>" + Environment.NewLine;
                    html += "</div>" + Environment.NewLine;
                    html += "<div class=\"ft_liveHelpButton g-m-a\">" + Environment.NewLine;
                    ...
                    html += "<span class=\"g-fc-2 g-fs-12\">Call: </span><span class=\"g-fc-5 g-fs-11\">" +
                            StandardFunctions.GetCMSEntry(websiteId, 2, 1, "T") + "</span>" + Environment.NewLine;
                    html += "</div>" + Environment.NewLine;
                    html += "</div>" + Environment.NewLine;
                    html += "</div>" + Environment.NewLine;
                    html += "</div>" + Environment.NewLine;
                    ...
                    html += "<div class=\"g-f-l ft_text1\">" + StandardFunctions.GetCMSEntry(websiteId, 41, 4, "T") +
                            "</div>" + Environment.NewLine;
                    html += StandardFunctions.GetCMSEntry(websiteId, 41, 5, "T") + Environment.NewLine;
                    html += "</div>" + Environment.NewLine;
                    html += "</div>" + Environment.NewLine;
                    ...
                    html += StandardFunctions.GetCMSEntry(websiteId, 41, 2, "T") + Environment.NewLine;
                    html += "</div>" + Environment.NewLine;
                    //Quick Links
                    html += "<div class=\"g-f-l ft_linkSection g-of-h g-w-a\">" + Environment.NewLine;
                    html += StandardFunctions.GetCMSEntry(websiteId, 41, 3, "T") + Environment.NewLine;
                    html += "</div>" + Environment.NewLine;
                    //Help & Advice 3
                    html += "<div class=\"g-f-l ft_linkSection g-of-h g-w-a\">" + Environment.NewLine;
                    html += StandardFunctions.GetCMSEntry(websiteId, 41, 15, "T") + Environment.NewLine;
                    html += "</div>" + Environment.NewLine;
                    //Help & Advice 4
                    html += "<div class=\"g-f-l ft_linkSection g-of-h g-w-a\">" + Environment.NewLine;
                    html += StandardFunctions.GetCMSEntry(websiteId, 41, 16, "T") + Environment.NewLine;
                    html += "</div>" + Environment.NewLine;
                    ...
                    html += StandardFunctions.GetCMSEntry(websiteId, 41, 8, "T") + Environment.NewLine;
                    ...
                    html += StandardFunctions.GetCMSEntry(websiteId, 41, 6, "T") + Environment.NewLine;
                    html += "</div>" + Environment.NewLine;
                    //Payment Types
                    ...
                    html += StandardFunctions.GetCMSEntry(websiteId, 41, 9, "T") + Environment.NewLine;
                    ...
                    html += StandardFunctions.GetCMSEntry(websiteId, 41, 11, "T") + Environment.NewLine;
                    html += "<div class=\"mob_footerRuleLine\"></div>" + Environment.NewLine;
        ...
        private static string feefoXML(int websiteId)
        {
            ...
            string feefoSiteName = StandardFunctions.WebsiteConfigSettings.Where(x => x.settingName == "feefoSiteName")
                .FirstOrDefault().settingValue;
            string siteName = StandardFunctions.WebsiteConfigSettings.Where(x => x.settingName == "siteName")
                .FirstOrDefault().settingValue;
            string testSite = StandardFunctions.WebsiteConfigSettings.Where(x => x.settingName == "testSite")
                .FirstOrDefault().settingValue;
            string siteRoot = addressPrefix + StandardFunctions.WebsiteConfigSettings
                                  .Where(x => x.settingName == "siteRoot").FirstOrDefault().settingValue;
            ...
            html += StandardFunctions.GetCMSEntry(websiteId, 41, 14, "T") + Environment.NewLine;
        ...
        private static void CreateScriptFiles(Dictionary<string, string> parms)
        {
            ...
            int websiteId = Convert.ToInt32(parms["websiteid"]);
            string awinId = "";
            string sliDomain = StandardFunctions.GetConfigurationSetting("Website Application Variables", "SLIDomain", websiteId);
            ...
            fileList.Add("cpy_inspectlet.js", "https://cdn.inspectlet.com/inspectlet.js");
            fileList.Add("cpy_sfliveagent.js", "https://c.la2w2.salesforceliveagent.com/content/g/js/36.0/deployment.js");
        ...
        private static void writeHTMLFile(string text, string outputFile)
        {
            ...
            {
                throw new ApplicationException("Error writing file: " + outputFile + ". Error Message: " + ex.Message);
            }
        }
    }
}