...
namespace IE_Ecommerce_Website
{
    public class MvcApplication : System.Web.HttpApplication
    {
        ...
        protected void Session_Start()
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(HttpContext.Current.Request.QueryString["gclid"]) && landingPage != "/" && string.IsNullOrEmpty(HttpContext.Current.Request.QueryString["utm_medium"]))
                {
