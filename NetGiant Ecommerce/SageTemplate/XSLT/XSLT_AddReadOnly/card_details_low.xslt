            ...
            <form method="post" name="carddetails" id="carddetails">
                ...
                <table class="formTable">
                    ...
                    <tr>
                        ...
                        <td class="data"><input name="cardfirstnames" size="30" maxlength="20" autocomplete="off"><xsl:attribute name="value"><xsl:value-of select="payment-model/transaction/billingfirstnames"/></xsl:attribute></input></td>
                        <td class="info"><xsl:value-of select="$i18n/multi-lingual-text/texts[lang($lang)]/text[@label='name_as_it_appears']"/></td>
                    </tr>
                    <tr>
                        ...
                        <td class="data"><input name="cardsurname" size="30" maxlength="20" autocomplete="off"><xsl:attribute name="value"><xsl:value-of select="payment-model/transaction/billingsurname"/></xsl:attribute></input></td>
                    ...
                    <xsl:if test="$vpsprotocol &lt; 2.23">
	                    <tr>
													...
													<td class="data" colspan="2"><xsl:value-of select="payment-model/transaction/billingaddress"/><BR/>
