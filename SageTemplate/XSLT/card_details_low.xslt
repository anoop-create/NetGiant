  		...
  		<div id="formCardDetails">
            ...
            <form method="post" name="carddetails" id="carddetails">
                ...
                <xsl:if test="$usingtoken != 'true'">
                  ...
                  <tr>
                    <td>
                      <span class="g-fw-b"><xsl:value-of select="$i18n/multi-lingual-text/texts[lang($lang)]/text[@label='cardnumber']"/>
                        <span>*</span>
                      </span>
                      <div>
                  ...
                  <tr>
                    <td>
						<div class="name-container1">
							<span class="g-fw-b">
							<xsl:value-of select="$i18n/multi-lingual-text/texts[lang($lang)]/text[@label='cardfirstnames']"/>
							<span>*</span>
						  </span>
						  <div>
						...
						<div class="name-container2">
							<span class="g-fw-b">
							<xsl:value-of select="$i18n/multi-lingual-text/texts[lang($lang)]/text[@label='cardsurname']"/>
							<span>*</span>
						  </span>
						  <div>
                  ...
                  <tr>
                    <td>
                      <span class="g-fw-b">VALID FROM</span>
                      <div>
                        ...
                        <select name="startyear" size="1" class="expiryYearSelect" style="width: 80px;">
                  ...
                  <tr>
                    <td>
                      <span class="g-fw-b">EXPIRES*</span>
                      <div>
                        ...
                        <select name="expiryyear" size="1" class="expiryYearSelect" style="width: 80px;">
                          <option value="" selected="" disabled="">Year</option>
                          <xsl:call-template name="generate_years">
                  ...
                  <tr>
                    <td>
                      ...
                      <div>
                        <input size="2" maxlength="2" name="cardissue" style="width: 200px;" autocomplete="off" placeholder="Issue Number"/>
                      </div>
                    </td>
                  </tr>
                  <tr>
                    <td>
                      <span class="g-fw-b">
                        <xsl:value-of select="$i18n/multi-lingual-text/texts[lang($lang)]/text[@label='security_code']"/>
                        <span>*</span>
                      </span>
                      <div>
                        <input size="5" maxlength="4" name="securitycode" style="width:100px;" autocomplete="off" placeholder="CVV / CVC"/>
                        <a href="#" class="g-cur-p g-m-l-10 g-fs-sm whatsThis" onclick="window.parent.launchPopup('CvcInfo', 'popup', 'sm', ''); return false;">What's This?</a>
                      </div>
                    </td>
                  </tr>
                  
                  <!--<tr>
                        <td class="label"><xsl:value-of select="$i18n/multi-lingual-text/texts[lang($lang)]/text[@label='cardnumber']"/><span>*</span></td>
                        <td class="data"><input name="cardnumber" size="30" autocomplete="off" placeholder="Card Number"/></td>
                    ...
                    <tr>
                        <td class="label"><xsl:value-of select="$i18n/multi-lingual-text/texts[lang($lang)]/text[@label='cardholdername']"/><span>*</span></td>
                    ...
                    <tr>
                        <td class="label"><xsl:value-of select="$i18n/multi-lingual-text/texts[lang($lang)]/text[@label='cardfirstnames']"/><span>*</span></td>
                        <td class="data"><input name="cardfirstnames" size="30" maxlength="20" autocomplete="off" placeholder="First Name"/></td>
                        <td class="info"><xsl:value-of select="$i18n/multi-lingual-text/texts[lang($lang)]/text[@label='name_as_it_appears']"/></td>
                    </tr>
                    <tr>
                        <td class="label"><xsl:value-of select="$i18n/multi-lingual-text/texts[lang($lang)]/text[@label='cardsurname']"/><span>*</span></td>
                        <td class="data"><input name="cardsurname" size="30" maxlength="20" autocomplete="off" placeholder="Last Name"/></td>
                  ...
                  <!--<span id="monthLabel"><span id="monthLabelText"><xsl:value-of select="$i18n/multi-lingual-text/texts[lang($lang)]/text[@label='month']"/></span></span>--><!--
                            <select name="startmonth" size="1" style="width: 80px;">
                              <option value="" selected="" disabled="">Month</option>
                                <xsl:call-template name="generate_months">
                                    <xsl:with-param name="start" select="1"/>
                                    <xsl:with-param name="end" select="13"/>
                    ...
                    <tr>
                        <td class="label"><xsl:value-of select="$i18n/multi-lingual-text/texts[lang($lang)]/text[@label='expiry_date']"/><span>*</span></td>
                        <td class="data" colspan="2">
                            --><!--<span id="monthLabel"><span id="monthLabelText"><xsl:value-of select="$i18n/multi-lingual-text/texts[lang($lang)]/text[@label='month']"/></span></span>--><!--
                            <select name="expirymonth" size="1" style="width: 80px;">
                              <option value="" selected="" disabled="">Month</option>
                                <xsl:call-template name="generate_months">
                                    <xsl:with-param name="start" select="1"/>
                                    <xsl:with-param name="end" select="13"/>
                    ...
                    <tr>
                        <td class="label"><xsl:value-of select="$i18n/multi-lingual-text/texts[lang($lang)]/text[@label='security_code']"/><span>*</span></td>
