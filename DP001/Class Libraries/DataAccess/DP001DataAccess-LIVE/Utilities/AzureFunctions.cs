...
using CloudQueueMessage = Microsoft.WindowsAzure.Storage.Queue.CloudQueueMessage;
    ...
    public class AzureFunctions
    {
        ...
        public static List<CloudBlobDetail> ListBlobContainerFileDetails(string blobContainer)
        {
            ...
            foreach (var file in files)
            {
                ...
                detail.DateLastModified =
                    CommonDataFunctions.ConvertDateTimeToCurrentTimeZone(blob.Properties.LastModified ?? DateTime.Now);
                results.Add(detail);
            }
        ...
        public static bool DeleteSinglePageBlobInBlobContainer(string blobContainer, string fileName)
        {
            var success = true;
            ...
            try
            {
                ...
                var client = account.CreateCloudBlobClient();
                var container = client.GetContainerReference(blobContainer);
                var blob = container.GetPageBlobReference(fileName);
        ...
        public static string DownloadFileFromBlobToString(string blobContainer, string fileName)
        {
            ...
            return blob.DownloadText(Encoding.GetEncoding("ISO-8859-1"));
        }
        ...
        public static bool WriteToAzureStorageQueue(string queueMessage)
        {
            try
            {
                var storageDp001String = ConfigurationManager.AppSettings["AzureStorageConnectionString"];
                ...
                var queue = queueClient.GetQueueReference(ConfigurationManager.AppSettings["AzureQueueName"]);
