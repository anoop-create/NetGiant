...
namespace DP001BusinessLogic
{
    public class Tenant
    {
        ...
        public delegate bool SalesHistoryDelegate(Channel channel);
        ...
        public delegate Dictionary<string, string> CustomConfigDelegate();
        ...
        public delegate string CustomDelegate2(string methodName, Channel channel);
        public CustomConfigDelegate CustomConfig { get; set; }
        public Dictionary<string, string> CustomConfigSettings { get; set; }

        public SupplierDelegate LoadSupplierInventory { get; set; }
        public ProductDelegate LoadProductInventory { get; set; }
        public SalesHistoryDelegate LoadSalesHistoryData { get; set; }
        ...
        public CustomDelegate2 CustomMethodOperatorField { get; set; }
        ...
        public void SetupTenantDelegates(Channel channel)
        {
            switch (channel.TenantSetting.Lookup.LookupName)
            {
                case "SaaS System":
                    ...
                    LoadSalesHistoryData = new SalesHistoryDelegate(LoadSalesHistory.PopulateSalesHistoryFromFtp);
        ...
        {
            switch (channel.TenantSetting.Description)
            {
                case "Netgiant":
                    CustomRoutines = NetGiant.Control;
                    CustomMethodOperatorField = NetGiant.GetCustomMethodOperatorField;
                    CustomConfig = NetGiant.GetCustomConfig;
                    break;
                case "Ekm":
                    CustomRoutines = Ekm.Control;
                    break;
            }
        }
        ...
        public Channel GetChannelRecord(int channelFk)
        {
            using (DP001Entities db = new DP001Entities())
            {
                return db.Channels
                    ...
                    .Include("CustomFields.Lookup")
                    .Include("FTPSettings.Suppliers")
                    .Include(x => x.TenantSetting.Contract)
                    .FirstOrDefault(x => x.ChannelID == channelFk);
            }
        }
    }
}
