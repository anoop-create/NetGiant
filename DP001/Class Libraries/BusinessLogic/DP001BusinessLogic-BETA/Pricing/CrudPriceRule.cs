...
namespace DP001BusinessLogic
{
    public class CrudPriceRule
    {
        ...
        public string BuildAuditString(PriceRule pr)
        {
            ...
            values += "#Method|" + crudLookup.Read(x => (x.LookupType.LookupTypeName == "Method" || x.LookupType.LookupTypeName == "CustomRuleMethod") && x.LookupID == pr.MethodFK).FirstOrDefault().LookupName;
