...
namespace DP001BusinessLogic.ViewModels
{
    public class ProviderExclusionViewModel
    {
        ...
        public List<Telerik> ProviderExclusionList { get; set; }
        public ProviderExclusion ProviderExclusionEntry { get; set; }
        public List<SelectListItem> AllProviders { get; set; }
        public List<SelectListItem> AllExclusionTypes { get; set; }
        //public List<CompetitorInventory> SearchCompetitorsResults { get; set; }
        public List<Competitor> SearchCompetitorsResults { get; set; }
        public List<Brand> SearchBrandsResults { get; set; }
        ...
        public void New()
        {
            ...
            AllExclusionTypes = SharedViewModel.GetLookupList("ProviderExclusionType");
        }
        ...
        public SaveReturn Update(ProviderExclusion providerExclusionEntry)
        {
            ...
            try
            {
                ...
                var dbRecord = crud.Read(x => x.ChannelFK == providerExclusionEntry.ChannelFK
                    && x.ProviderExclusionID == providerExclusionEntry.ProviderExclusionID).FirstOrDefault();

                if (dbRecord != null)
                {
                    dbRecord.Comment = providerExclusionEntry.Comment;
        ...
        public ProviderExclusionViewModel SearchCompetitors(string term)
        {
            using (var db = new DP001Entities())
            {
                SearchCompetitorsResults = db.Competitors
                    .Where(x => x.CompetitorInventories.Count > 0 && x.ChannelFK == _channelId)
        ...
        public ProviderExclusionViewModel SearchBrands(string term)
        {
            var crud = new CrudBrand();
            SearchBrandsResults = crud.Read(x =>
                x.ChannelFK == _channelId &&
                x.BrandName.Contains(term)).DistinctBy(x => x.BrandName).ToList();
        ...
        public class Telerik
        {
            ...
            public string ExclusionLevel { get; set; }
            public string Comment { get; set; }
        }
    }

    public static class ProviderExclusionExtensions
    {
        public static List<ProviderExclusionViewModel.Telerik> AsTelerikViewModel(this List<ProviderExclusion> query)
        {
            return query.Select(o => new ProviderExclusionViewModel.Telerik
            {
                ProviderExclusionId = o.ProviderExclusionID,
                ExclusionType = o.Lookup.LookupName,
                ProviderName = o.ProviderName,
                BrandName = o.BrandName,
                ProdId = o.ClientProductID,
                Mfpn = o.ManufacturerPartNo,
                ExclusionLevel = o.Lookup1.LookupName,
                Comment = o.CompetitorDescription
            }).ToList();
        }
    }
}
