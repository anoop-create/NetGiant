            ...
            if (deleteRecord != null)
            {
                try
                {
                    if (deleteRecord.Lookup.LookupName == "Product Inventory Field")
                    {
                        ...
                        //TODO: Clear to 0 Any PriceRule AltPriceAdj/AdjMinMargin/AdjMaxMargin fields if this a CustomPriceAdjustment field
                        //TODO: Clear to 0 any ProductInventory AltPriceAdj fields if this a CustomPriceAdjustment field
                    }
