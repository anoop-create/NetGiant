...
namespace DP001BusinessLogic
{
    public class CrudCompetitorInventory : ICRUD<CompetitorInventory>
    {
        ...
        public bool Create(List<CompetitorInventory> competitors, Channel channel)
        {
            DataTable dt = new DataTable("StagingCompetitorInventory");
            //DataTable dt1 = new DataTable("TestingCompetitorInventory");
            ...
            using (DP001Entities db = new DP001Entities())
            {
                ...
                //dt1.Columns.Add(new DataColumn("ChannelFK", typeof(int)));
                //dt1.Columns.Add(new DataColumn("CompetitorFK", typeof(int)));
                //dt1.Columns.Add(new DataColumn("BrandFK", typeof(int)));
                //dt1.Columns.Add(new DataColumn("ManufacturerPartNo", typeof(string)));
                //dt1.Columns.Add(new DataColumn("Price", typeof(decimal)));
                //dt1.Columns.Add(new DataColumn("OriginalBrand", typeof(string)));
                //dt1.Columns.Add(new DataColumn("ClientProductID", typeof(string)));
                ...
                foreach (CompetitorInventory ci in competitors)
                {
                    dt.Rows.Add(
                        ...
                        ci.CompetitorFK, 
                        ci.BrandFK, 
                        ci.ManufacturerPartNo.Truncate(45), 
                        ci.Price, 
                        ci.OriginalBrand.Truncate(100), 
                        ci.ClientProductID.Truncate(45),
                        ci.Description.Truncate(200));
            ...
            CommonDataFunctions.CreateLogEntry(channel, "CreateCompetitorData Number of records: " + dt.Rows.Count, "Information");
            SQL.SQLBulkInsert(dt, "DP001");
            //SQL.SQLBulkInsert(dt1, "DP001");
            ...
            CommonDataFunctions.CreateLogEntry(channel, "END CreateCompetitorData - COMPUTE", "Information");
            CommonDataFunctions.CreateLogEntry(channel, "START CreateCompetitorData - SQL", "Information");

            var isSuccess = SQL.ExecuteStoredProcedure("DP001", "CreateUpdateCompetitorInventory", sqlParms, channel.ChannelID);

            CommonDataFunctions.CreateLogEntry(channel, "END CreateCompetitorData - SQL", "Information");
