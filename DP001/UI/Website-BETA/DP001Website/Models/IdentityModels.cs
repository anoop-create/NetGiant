...
namespace DP001Website.Models
{
    ...
    public class UserViewModel
    {
        ...
        public List<Telerik> AllTelerikUsers { get; set; }
        ...
        private void GetAllUsers()
        {
            ...
            AllTelerikUsers = AllUsers.AsTelerikViewModel();
        }
    ...
    {
        public static List<UserViewModel.Telerik> AsTelerikViewModel(this List<UserViewModel.AllTheUsers> query)
        {
            return query.Select(o => new UserViewModel.Telerik
            {
                UserId = o.AppUser.Id,
                UserName = o.AppUser.UserName,
                EmailAddress = o.AppUser.Email,
