    ...
    public class AccountController : ApplicationController
    {
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                Email.SendEmail("Please reset your password by clicking <a href=\"" + callbackUrl + "\">here</a>", 
                    "Reset Password", 
                    new List<string> { model.Email }, 
                    "noreply@priceology.netgiant.com");
        ...
        //Users Controller Actions`
        [Authorize(Roles = "SuperAdmin")]
        public ActionResult ListUsers_Read([DataSourceRequest]DataSourceRequest request)
        {
            UserViewModel model = new UserViewModel();
            var result = model.AllTelerikUsers.ToDataSourceResult(request);
        ...
        [Authorize(Roles = "SuperAdmin")]
        public ActionResult ClientCounts_Read([DataSourceRequest]DataSourceRequest request)
        {
            var model = new TenantSettingsViewModel();
            model.GetClientCounts();

            var result = model.ClientCounts.ToDataSourceResult(request);
            var jsonResult = Json(result);
            jsonResult.MaxJsonLength = int.MaxValue;
            return jsonResult;
        }
