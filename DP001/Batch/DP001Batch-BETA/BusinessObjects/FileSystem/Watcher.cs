    ...
    public class Watcher
    {
        ...
        private static void OnFileCreated(object sender, FileSystemEventArgs e)
        {
            ...
            try
            {
                ...
                Global.AssignJobId();
                CommonDataFunctions.CreateLogEntry(Int32.Parse(dictionary["tenantid"]), Int32.Parse(dictionary["channelid"]), "START JOB: " + CommonFunctions.DictToString(dictionary, null) + ". " + ConfigurationManager.AppSettings["CPU"] + ". " + ConfigurationManager.AppSettings["Environment"] + ".", "Information", true);
                var switchDetect = new SwitchDetection();
                switchDetect.DetectSwitch(dictionary);
                CommonDataFunctions.CreateLogEntry(Int32.Parse(dictionary["tenantid"]), Int32.Parse(dictionary["channelid"]), "END JOB: " + CommonFunctions.DictToString(dictionary, null), "Information", true);
