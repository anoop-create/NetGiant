...
namespace DP001Batch.BusinessObjects.Shared
{
    public class SwitchDetection
    {
        ...
        internal static void DetectSwitch(Dictionary<string, string> parms)
        {
            switch (parms["type"])
            {
        ...
        private static void CalculatePrices(Dictionary<string, string> parms)
        {
        ...
        private static void LoadInventories(Dictionary<string, string> parms)
        {
            CommonDataFunctions.NotificationEvent += NotificationRaised;
