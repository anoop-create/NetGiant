$(document).ready(function () {
    ...
    $('.mobile-menu-item').click(function () {
        if ($(this).attr('data-menu-default') == "True") return;

        $(this).parent().addClass('g-d-n');
        $('ul[data-sub-menu=' + $(this).attr('data-action-link-id') + ']').removeClass('g-d-n');
    });

    $('.mobile-menu-back').click(function () {
        $('#mobile-menu ul').first().removeClass('g-d-n');
        $('#mobile-menu ul').slice(1).addClass('g-d-n');
    });

    $('.mobile-menu-toggle').click(function () {

        var isVisible = !$(this).siblings().first().hasClass('g-d-n');

        $('.mobile-sub-menu-item ul').each(function () {
        ...
        if (!isVisible) {
            $(this).siblings().first().removeClass('g-d-n');
        }
...
function ajaxDeleteTelerikRow(optionsArray, url, divDeleteDialog) {
...
function resizeGrid() {
    if ($('.k-grid').length > 0) {
        var gridElement = $('.k-grid'),
            ...
            gridHeight = $(window).height() - $('.k-grid').offset().top,
