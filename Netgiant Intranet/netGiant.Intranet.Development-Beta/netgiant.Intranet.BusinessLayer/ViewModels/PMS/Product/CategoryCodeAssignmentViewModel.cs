...
{
    public class CategoryCodeAssignmentViewModel : CommonViewModel
    {
        private ngmdEntities _ctx;

        public CategoryCodeAssignmentViewModel()
        {
            _ctx = new ngmdEntities();
        }

        public IQueryable<TelerikCategoryCodeAssignment> CategoryCodeAssignmentList { get; set; }
        ...
        public CategoryCodeAssignmentViewModel Get()
        {
            CategoryCodeAssignmentList = _ctx.websiteInventory
                                       .Select(x => new TelerikCategoryCodeAssignment
                                       {
                                           ...
                                           Manufacturer = x.product.manufacturer.manufacturerName,
                                           ProductStatus = (_ctx.Lookup
                                            .Where(y => y.LookupType.LookupTypeName == "ProductStatus" && y.AltLookupId == x.product.productStatusFK)
                                            .AsQueryable()
                                            .FirstOrDefault()
                                            .LookupName),
                                           ProductGroup = x.product.productGroup.productGroupName,
                                           SalesAreaGroup = x.product.salesAreaGroup.salesAreaGroupName,
                                           DataSupplier = x.product.dataSupplier.dataSupplierName
                                       })
                                       .AsQueryable();
            return this;
        }
        ...
        //        ProductStatusList = SelectListViewModel.GetNgmdLookupSelectList("ProductStatus");
    ...
    public class TelerikCategoryCodeAssignment
    {
        public int Id { get; set; }
