...
{
    public class SharedFunctions : CommonViewModel
    {
        ...
        public static string GetCmsEntry(string sectionName, string entryName)
        {
            ...
            {
                content = db.cmsEntry
                    .FirstOrDefault(x => x.entryName == entryName && x.cmsSection.sectionName == sectionName)
                    ?.cmsContent;
            }
        ...
        {
            AddStandardReplacements(replacements);
        ...
        public static string DoReplacements(string originalString, string replacements)
        {
            AddStandardReplacements(replacements);
            if (replacements != "")
            {
                ...
                {
                    string[] c = b.Split('=');
                    originalString = originalString.Replace("[" + c[0] + "]", c[1]);
                }
            }
        ...
        public static string ModifyForPopup(bool isPopup)
        {
            return isPopup ? "~/Views/Shared/_LayoutPopup.cshtml" : "~/Views/Shared/_Layout.cshtml";
            //return isPopup ? "~/Views/Shared/_LayoutEmpty.cshtml" : "~/Views/Shared/_Layout.cshtml";
        }
    }
