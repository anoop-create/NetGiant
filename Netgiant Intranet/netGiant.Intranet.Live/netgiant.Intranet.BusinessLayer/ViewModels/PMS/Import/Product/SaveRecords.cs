    ...
    public class SaveRecords
    {
        ...
        private void UpdateProduct(ImportFields prd, product dbProd)
        {
            using (ngmdEntities db = new ngmdEntities())
            {
                ...
                dbProd.pageYield = prd.pageYield != null ? prd.pageYield : dbProd.pageYield;
        ...
        private void UpdateAxisFields(ImportFields prdSup, product dbProd)
        {
            using (ngmdEntities db = new ngmdEntities())
            {
                ...
                dbAfs.supressOpenRangeImage = prdSup.supressOpenRangeImage != null ? prdSup.supressOpenRangeImage : dbAfs.supressOpenRangeImage;
                dbAfs.supressOpenRangeSpec = prdSup.supressOpenRangeSpec != null ? prdSup.supressOpenRangeSpec : dbAfs.supressOpenRangeSpec;
            ...
            using (ngmdEntities db = new ngmdEntities())
            {
                ...
                //{
                    if (dbAxsAdditional != null)
                    {
                        ...
                        dbAxsAdditional.googlePromotionId = prdSup.googlePromotionId != null ? prdSup.googlePromotionId : dbAxsAdditional.googlePromotionId;
                        dbAxsAdditional.breakQuantity1 = prdSup.breakQuantity1 != null ? prdSup.breakQuantity1 : dbAxsAdditional.breakQuantity1;
                        dbAxsAdditional.breakQuantity2 = prdSup.breakQuantity2 != null ? prdSup.breakQuantity2 : dbAxsAdditional.breakQuantity2;
                        dbAxsAdditional.breakQuantity3 = prdSup.breakQuantity3 != null ? prdSup.breakQuantity3 : dbAxsAdditional.breakQuantity3;
