...
namespace netGiant.Intranet.Controllers
{
    ...
    public class AccountController : ApplicationController
    {
        ...
        public ActionResult RegisterUser()
        {
            ...
            return View("~/Views/Account/RegisterUser.cshtml", model);
        }
        ...
        public async Task<ActionResult> SaveNewUser(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    return PartialView("~/Views/Account/RegisterUser.cshtml", new RegisterViewModel() { IsNew = true });
                }
                else
                {
                    AddErrors(result);
        ...
        public ActionResult ListRoles()
        {
            ...
            return View("~/Views/Account/ListRoles.cshtml", model);
        }
        ...
        public ActionResult ListUsers()
        {
            ...
            return View("~/Views/Account/ListUsers.cshtml", allUsers);
        }
        ...
        private ActionResult RedirectRoleBased(bool defaultAction)
        {
            ...
            {
                return RedirectToAction("ManufacturerNotesIndex", "ManufacturerNotes");
            }
        ...
        {
            return View("~/Views/Account/NoUserRoles.cshtml");
        }
